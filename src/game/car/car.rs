...
// Add this after your spawn_car function
pub fn despawn_cars(mut commands: Commands, query: Query<Entity, With<Car>>) {
    for entity in query.iter() {
        // Despawn car and all its child entities (wheels)
